...
def start_sysexam_on_host(sysexam_verify_xml_path, verify_results_csv_path):
    ...
    xml_regs_df = ut.read_register_fields_in_dataframe(xml_regs_df, 'hex', False, 100, 20, False) # update bitfield values for each xml_reg
    # print(xml_regs_df)
...
start_sysexam_on_host("C:/Users/powerhost/Documents/PycharmProjects/PowerTools/static/sysexam/xml/PRPinnacleRidgeAM4/sysexam_registers_pram4_nbio.xml",
                      "C:/Users/powerhost/Documents/AMD/Projects/PRPinnacleRidgeAM4/Data/SystemPwrFeatures/Idle/SysExam/pram4_b2_w10rs3_wmp8110n_17.12.2adrenalinedition_nbio_sysexam_0.csv")
